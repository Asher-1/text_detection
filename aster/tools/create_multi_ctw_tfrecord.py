...
OUT_PATH = os.path.join(ROOT_PATH, "ctw2.tfrecord")
...
def main(_):
    ...
    for index in tqdm(indices):
        ...
        words = []
        char_polygons_list = []
        for char_set in tools.each_char(anno):
            chars = ""
            bboxes = []
            for char in char_set:
                ...
                if FLAGS.crop_margin > 0:
                    ...
                    bboxes.append([bbox_x, bbox_y, bbox_x + bbox_w, bbox_y + bbox_h])
            ...
            bbox_array.append([x_min, y_min, x_max, y_max])
            words.append(chars)
