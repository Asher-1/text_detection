...
class RecognitionEvaluation(object):
    ...
    def add_single_image_recognition_info(self, image_key, recognition_text, groundtruth_text):
        ...
        self.all_groundtruth_text.append("".join(groundtruth_text.decode('utf-8').split("^")))
    ...
    def evaluate_all(self):
        ...
        for i in range(num_samples):
            recogition = self.all_recognition_text[i]
            groundtruth = self.all_groundtruth_text[i]
