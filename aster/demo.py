...
# EXP_DIR = 'aster/experiments/demo/'
EXP_DIR = '/media/yons/data/dataset/models/text_detection_models/ASTER/output'

flags = tf.app.flags
flags.DEFINE_string('exp_dir', EXP_DIR,
...
def main(_):
    ...
    ckpt = tf.train.get_checkpoint_state(os.path.join(FLAGS.exp_dir, 'log/'))
