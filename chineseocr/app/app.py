...
# from apphelper.tools import his_equl_color
...
class OCR:
    ...
    def POST(self):
        ...
        # tmp_file = os.path.join(pathinfo.TMP_FOLDER, "tmp.jpg")
        ...
        os.remove(path)
        return json.dumps({'res': res, 'timeTake': round(timeTake, 4)}, ensure_ascii=False, indent=4)
