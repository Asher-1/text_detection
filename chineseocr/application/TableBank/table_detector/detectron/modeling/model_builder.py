...
from .detector import DetectionModelHelper
from ..roi_data.loader import RoIDataLoader
from . import fast_rcnn_heads as fast_rcnn_heads
from . import keypoint_rcnn_heads as keypoint_rcnn_heads
from . import mask_rcnn_heads as mask_rcnn_heads
from . import name_compat as name_compat
from . import optimizer as optim
from . import retinanet_heads as retinanet_heads
from . import rfcn_heads as rfcn_heads
from . import rpn_heads as rpn_heads
from ..roi_data import minibatch as roi_data_minibatch
from ..utils import c2 as c2_utils
...
def get_func(func_name):
    ...
    try:
        ...
        import os
        module_path = os.path.dirname(__file__).split(os.path.sep)[-3:]
        module_name = '.'.join(module_path) + '.' + '.'.join(parts[:-1])
...
from . import VGG_CNN_M_1024 as VGG_CNN_M_1024
