...
# backbone)
__C.MODEL.CONV_BODY = 'add_fpn_ResNet101_conv5_body'
...
__C.FAST_RCNN.ROI_BOX_HEAD = 'fast_rcnn_heads.add_roi_2mlp_head'
...
__C.FAST_RCNN.ROI_XFORM_RESOLUTION = 7
...
__C.RESNETS.NUM_GROUPS = 32

# Baseline width of each group
__C.RESNETS.WIDTH_PER_GROUP = 8
...
# ---------------------------------------------------------------------------- #
_RENAMED_MODULES = {
    'detectron.utils.collections': 'table_detector.detectron.utils.collections',
}
