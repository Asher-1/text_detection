...
def create_dataset():
    ...
    train_num = int(len(file_list) * TRAIN_TEST_RATIO)
    TRAIN_EXAMPLE = file_list[:train_num]
    TEST_EXAMPLE = file_list[train_num:]
...
if __name__ == '__main__':
    ...
    TRAIN_ANNOTATION_PATH = os.path.join(ROOT_PATH, "data_train.txt")
    TEST_ANNOTATION_PATH = os.path.join(ROOT_PATH, "data_test.txt")
