...
class Recognition(object):
    ...
    def bilstm(self, input_feature, seq_len):
        with tf.variable_scope("recog/rnn"):
            ...
            lstm_bw_cell = tf.nn.rnn_cell.DropoutWrapper(lstm_bw_cell, input_keep_prob=self.keepProb,
                                                         output_keep_prob=self.keepProb)
            ...
            infer_output, _ = tf.nn.bidirectional_dynamic_rnn(lstm_fw_cell, lstm_bw_cell, input_feature,
