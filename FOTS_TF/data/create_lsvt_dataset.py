...
def create_datasets():
    ...
    annotation_dict = json.loads(groundtruth.strip())
    for image_id, anno in tqdm(list(annotation_dict.items())):
        try:
            ...
            with open(label_file, "w", encoding="utf-8") as f:
                for block in anno:
                    ...
                    difficulty = "1" if block['illegibility'] else "0"
...
if __name__ == '__main__':
    ROOT_PATH = "/media/yons/data/dataset/images/text_data/ICDAR2019/LSVT/"
    ...
    IMAGE_DIR = os.path.join(ROOT_PATH, "train_full_images")
    train_annatations = os.path.join(ROOT_PATH, "train_full_labels.json")
