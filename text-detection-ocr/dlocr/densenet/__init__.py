...
# default_densenet_weight_path = "/media/yons/data/dataset/models/text_detection_models/text_detection_ocr/output/" \
#                                "weights-densent-23.hdf5"
print("default_densenet_weight_path : {}".format(default_densenet_weight_path))
