...
from dlocr.densenet import default_dict_path
from dlocr.densenet import default_densenet_config_path
from dlocr.densenet import default_densenet_weight_path

if __name__ == '__main__':
    import argparse

    densenet_weight_path = "/media/yons/data/dataset/models/text_detection_models/text_detection_ocr/output/" \
                           "weights-densent-15.hdf5"
    os.environ['CUDA_VISIBLE_DEVICES'] = "0"
    parser = argparse.ArgumentParser()
    parser.add_argument("-ie", "--initial_epoch", help="初始迭代数", default=15, type=int)
    parser.add_argument("-bs", "--batch_size", help="小批量处理大小", default=128, type=int)
    parser.add_argument("--epochs", help="迭代数", default=30, type=int)
    parser.add_argument("--gpus", help="gpu的数量", default=1, type=int)
    parser.add_argument("--images_dir", help="图像位置",
                        default="/media/yons/data/dataset/images/text_data/syn_chinese_data/syn_images3")
    parser.add_argument("--dict_file_path", help="字典文件位置",
                        default=default_dict_path)
    parser.add_argument("--train_file_path", help="训练文件位置",
                        default="/media/yons/data/dataset/images/text_data/syn_chinese_data/syn_train3.txt")
    parser.add_argument("--test_file_path", help="测试文件位置",
                        default="/media/yons/data/dataset/images/text_data/syn_chinese_data/syn_test3.txt")
    ...
    parser.add_argument("--weights_file_path", help="模型初始权重文件位置",
                        default=densenet_weight_path)
    parser.add_argument("--save_weights_file_path", help="保存模型训练权重文件位置",
                        default=r'/media/yons/data/dataset/models/text_detection_models/'
                                r'text_detection_ocr/output/weights-densent-{epoch:02d}.hdf5')
    ...
    # 测试
    # images_dir = "/media/yons/data/dataset/images/text_data/syn_chinese_data/syn_images"
    # dict_file_path = "dictionary/char_std_5072.txt"
    # train_labeled_file_path = "/media/yons/data/dataset/images/text_data/syn_chinese_data/syn_train.txt"
    # test_labeled_file_path = "/media/yons/data/dataset/images/text_data/syn_chinese_data/syn_test.txt"
