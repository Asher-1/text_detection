...
ROOT_PATH = "/media/yons/data/dataset/models/text_detection_models/PSEnet/model/"
test_data_path = "./test/license/"
tf.app.flags.DEFINE_string('test_data_path', test_data_path, '')
tf.app.flags.DEFINE_string('gpu_list', '0', '')
tf.app.flags.DEFINE_string('checkpoint_path', ROOT_PATH, '')
tf.app.flags.DEFINE_string('output_dir', './test/results/', '')
